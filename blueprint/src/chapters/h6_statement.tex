...
\begin{definition}[Fixed standard and computational sphere objects]
  ...
  \lean{KIP126.Classical.Adams.sphereAdams}
  \lean{KIP126.Classical.Adams.sphereH6Square}
  \lean{KIP126.Classical.Adams.sphereAdamsData}
  \lean{KIP126.Classical.Adams.computedH6Square}
  \lean{KIP126.Core.SpectralSequence.NonzeroSurvival}
  ...
  The computational object uses the internal SSData presentation; its specified
  ...
  Foundation selection, the internal model, the range-limited Lin comparison,
  and the tower, class, and survival comparisons remain named development
  axioms. They do not assert that the specified class survives. The internal
