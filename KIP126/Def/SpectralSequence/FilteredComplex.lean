...
import KIP126.Def.SpectralSequence.FilteredComplex.Adapter.Proofs

/-!
# Filtered complexes and their nested-subobject spectral sequences

This public module combines KIP126's canonical Mathlib `ChainComplex`-based
filtered complex with the migrated historical `SSData` construction.
-/
