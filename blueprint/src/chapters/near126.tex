...
\begin{theorem}[$h_6^2$ is a permanent cycle]
  ...
  The corresponding Lean theorem states this over the abstract foundation
  and explicit Milnor coordinates, with its proof left as \texttt{sorry}.
  It remains an open Challenge theorem; no completed proof is claimed.
\end{theorem}
