...
\begin{definition}[Reindexed spectral-sequence morphism]
  ...
  \notready
  For every fixed synthetic weight and every page $r\geq2$, a reindexed
  morphism supplies a homological-complex map from the classical page to the
  corresponding fixed-weight synthetic page, together with page-passage
  isomorphisms and their coherence.  Commutation with differentials is derived
  from the chain-map law.  This realizes the forgetful grading map
