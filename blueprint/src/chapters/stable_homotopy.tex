\chapter{Stable-homotopy objects}
\label{chap:stable-background}

This chapter defines the stable-homotopy language required by the paper.  Located May, Moss, and Toda inputs are stated later in the external-results chapter rather than treated as definitions.
