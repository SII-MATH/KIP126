...
\begin{theorem}[BJM/BX criterion for the source choice]
  ...
  \lean{KIP126.Kervaire.cataloguedBJM_BXCriterion}
...
\begin{theorem}[External $\theta_5$ order and choice comparison]
  ...
  \lean{KIP126.Kervaire.cataloguedTheta5OrderData}
  \uses{def:synthetic-theta5-choice,def:external-result}
  \notready
...
% SOURCE: reference/BurklundXu/paper.txt:3475-3492, Proposition 7.19 in the
% archived version; aimpaper/main.tex:2133-2139, Remark rem:theta5choice.
% The present Lean declaration TotalDifferentialIdentity quantifies over every
% order-two choice and is therefore NOT a matching external-result interface.
