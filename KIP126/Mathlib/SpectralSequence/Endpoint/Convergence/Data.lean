import KIP126.Mathlib.SpectralSequence.Endpoint.Extension.Data
import KIP126.Def.Algebra.Completion.Data

/-! Mathlib-facing convergence and detection witnesses for an endpoint-extended spectral sequence. -/
