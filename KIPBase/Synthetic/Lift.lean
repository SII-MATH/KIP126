...
open CategoryTheory CategoryTheory.Limits CategoryTheory.Pretriangulated
  KIPBase.SpectralSequence KIPBase.StableHomotopy
...
/-- KIP §3, Proposition 3.19: Given a cofiber sequence X → Y → Z → ΣX in 𝒮,
...
/-- KIP §3, Proposition 3.20 (f̂ triangle): Given a cofiber sequence
...
/-- KIP §3, Notation 3.19 (cofiber of f̂): The distinguished triangle
