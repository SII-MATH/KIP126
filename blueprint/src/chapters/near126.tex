...
\begin{proof}
  ...
  Proposition~\ref{evidence:theta5-order-torsion}.  Then use the internal
  correction-vanishing theorem and the source-choice total differential
  identity to establish choice independence.
