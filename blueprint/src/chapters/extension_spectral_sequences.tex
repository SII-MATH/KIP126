...
\begin{definition}[$f$-extension spectral sequence]
  ...
  \uses{def:filtered-two-term-complex,def:core-filtered-chain-complex,def:ess-complex-shape,thm:filtered-complex-to-spectral-sequence,def:strong-convergence-detection}
  \notready
  The $f$-extension spectral sequence, or $f$-ESS, is the spectral sequence of
  the Adams-filtered two-term complex.  Its initial page and abutment are
  \[
  ...
  $f$ on associated graded homotopy groups.
\end{definition}
