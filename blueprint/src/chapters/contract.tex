...
\begin{definition}[KIP126 trust boundary]
  ...
  \uses{def:external-result,def:external-evidence,def:open-proposition}
  \notready
  ...
  external evidence.  No project declaration may use \texttt{axiom},
  \texttt{sorry}, or \texttt{admit}; the two geometric endpoints are
